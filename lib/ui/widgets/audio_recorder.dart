...
class Recorder extends StatefulWidget {
  final void Function(String path, int lengthSeconds) onStop;
  final void Function() onStart;

  const Recorder({Key? key, required this.onStop, required this.onStart}) : super(key: key);
